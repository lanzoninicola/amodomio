...
export default function AdminMobilePedidoFornecedorQuantidades() {
  ...
  const { supplier, items, supplierId } = payload as any;
  ...
  return (
    <div className="space-y-4 pb-8">
      ...
      >
        {items.map((item: any, index: number) => (
          ...
          >
            ...
            <div className="mb-3">
              ...
              <h2 className="mt-1 text-base font-bold leading-tight text-slate-900">
                {item.itemName}
              </h2>
            </div>
            ...
            <div className="grid grid-cols-[1fr_92px] gap-3">
              ...
              <label className="block">
                ...
                >
                  {item.unitOptions.map((unit: string) => (
        ...
        <button
          type="submit"
          className="flex w-full items-center justify-center gap-2 rounded-xl bg-slate-900 py-3.5 text-sm font-semibold text-white"
        >
          Ver riepilogo
