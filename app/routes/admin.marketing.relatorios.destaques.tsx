...
import { readCardapioHighlightReport } from "~/domain/cardapio/tracking/reports/cardapio-highlight-report.server";
...
export async function loader({ request }: LoaderFunctionArgs) {
  ...
  return defer({
    ...
    report: readCardapioHighlightReport({
...
export default function AdminMarketingHighlightReport() {
