...
export default function AdminMarketingCampaignLayout() {
  return (
        ...
        <section className="space-y-5 border-b border-slate-200/80 pb-5">
          <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            <div className="flex flex-wrap items-center gap-2 text-sm">
              ...
              <span className="text-slate-300">/</span>
              <span className="font-medium text-slate-900">campanhas</span>
            </div>
          ...
          <div className="space-y-1">
            ...
            <p className="text-sm text-slate-500">
              Gerencie campanhas de marketing e acompanhe os envios registrados.
            </p>
          </div>
        </section>
