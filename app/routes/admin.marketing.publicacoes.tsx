...
export const meta: MetaFunction = () => [{ title: "Publicações | Marketing" }];

export default function AdminMarketingContentPostsLayout() {
  return (
        ...
        <section className="space-y-4 border-b border-slate-200/80 pb-4 sm:space-y-5 sm:pb-5">
          ...
          <div className="space-y-1">
            ...
            <p className="text-sm text-slate-500">
              Crie o conteúdo uma vez e distribua para cardápio, WhatsApp e
              Instagram.
            </p>
          </div>
        </section>
