...
export const meta = () => [{ title: "Tags | Cardápio" }];

export default function AdminVendasCardapioTagsOutlet() {
  return (
        ...
        <section className="space-y-5 border-b border-slate-200/80 pb-5">
          <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            <div className="flex flex-wrap items-center gap-2 text-sm">
              <Link
                to="/admin/gerenciamento/cardapio"
            ...
            <Link
              to="/admin/vendas/cardapio/tags?new=1"
