...
export default function AdminCanaisVendaOutlet() {
  return (
      ...
      <div className="flex flex-col gap-6">
        <section className="space-y-5 border-b border-slate-200/80 pb-5">
          <div className="flex flex-wrap items-center gap-2 text-sm">
            ...
            <span className="font-medium text-slate-900">canais de venda</span>
          </div>

          <div className="space-y-1">
            <h1 className="text-2xl font-semibold tracking-tight text-slate-950">Canais de venda</h1>
            <p className="max-w-3xl text-sm text-slate-500">
              Cadastro e manutenção dos canais usados na matriz nativa de preços dos itens.
            </p>
          </div>
        </section>
