    ...
    <div className="flex flex-col gap-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Ajuste o canal, tamanho e período para recalcular a matriz.
          </CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <div className="grid gap-4 md:grid-cols-4">
        ...
        <Card>
          <CardHeader>
            <CardTitle>Com precificação</CardTitle>
        ...
        <Card>
          <CardHeader>
            <CardTitle>Média de vendas</CardTitle>
        ...
        <Card>
          <CardHeader>
            <CardTitle>Média de margem</CardTitle>
      ...
      <Card className="overflow-hidden">
        ...
        <CardContent className="grid gap-6 xl:grid-cols-[220px_minmax(0,1fr)_300px]">
          <div className="flex flex-col gap-4">
            <p className="text-sm font-semibold text-muted-foreground">Legenda</p>
          ...
          <div className="rounded-2xl border border-border bg-white/90 p-5 shadow-sm">
            <div className="flex items-center justify-between">
              <p className="text-sm font-semibold text-muted-foreground">Detalhes</p>
              {hovered ? (
            ...
            <div className="mt-4 space-y-3 text-sm">
              <div className="flex items-center justify-between">
                <span className="text-muted-foreground">Avg de margem</span>
                <span className="font-semibold">{formatCurrency(data.thresholds.marginAvgAmount)}</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-muted-foreground">Total transações</span>
                <span className="font-semibold">{data.summary.totalSalesQty}</span>
              </div>
              <div className="flex items-center justify-between">
      ...
      <Card>
        ...
        <CardContent className="grid gap-3 text-sm md:grid-cols-3">
          <div className="rounded-md border border-border p-3">
            ...
            <p className="text-lg font-semibold">{data.summary.totalSalesQty}</p>
          </div>
          <div className="rounded-md border border-border p-3">
            <p className="text-xs text-muted-foreground">Vendas mapeadas</p>
            <p className="text-lg font-semibold">{data.summary.matchedSalesQty}</p>
          </div>
          <div className="rounded-md border border-border p-3">
            <p className="text-xs text-muted-foreground">Vendas sem match</p>
            <p className="text-lg font-semibold">{data.summary.unmatchedSalesQty}</p>
          </div>
        </CardContent>
      </Card>
    </div>
