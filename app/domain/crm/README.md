...
### Campanhas — `admin.marketing.campaign.*.tsx`

CRUD de campanhas em `/admin/marketing/campaign`, com lista, busca e contagem de envios. Campanhas com envios registrados não podem ser eliminadas.
