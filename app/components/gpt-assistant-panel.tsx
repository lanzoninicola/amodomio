    ...
    return (
        <div className="mx-auto max-w-5xl space-y-6">
            ...
            <Form method="post" action={formAction} preventScrollReset className="space-y-4">
                ...
                <Tabs defaultValue="prompt" className="w-full space-y-4">
                    <div className="overflow-x-auto">
                        <TabsList className="min-w-max rounded-lg border border-slate-200 bg-slate-50/90">
                            ...
                            <div className="border-b border-slate-200 px-4 py-3">
                                <div className="flex flex-wrap items-start justify-between gap-3">
                                    ...
                                    <div className="flex flex-wrap items-center gap-2">
                                        ...
                                        {externalUrl ? (
                                            <Button type="button" variant="outline" size="sm" asChild>
                                                <a href={externalUrl} target="_blank" rel="noreferrer" className="flex items-center gap-x-2">
                                                    {externalLabel}
